...
public class BuscarProductoFactura extends javax.swing.JFrame {
    ...
    /**
     * Creates new form BuscarProductoFactura
     */
...
//        System.out.println(r);
            ...
            ps = cn.prepareStatement("SELECT id_producto ,descripcion ,precio_venta FROM producto");
            r = ps.executeQuery();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            tabla.addColumn("descripcion");
            tabla.addColumn("precio_venta");
            cts = cn.prepareCall("{call filtraProductoId(?)}");
            cts.setString(1, x);
            r = cts.executeQuery();
